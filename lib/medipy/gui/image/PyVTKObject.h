/**
 * This file might not be included by all VTK distributions (e.g. Ubuntu 10.04).
 * This specific version was taken from Ubuntu 12.04.
 */
...
extern PyTypeObject PyVTKObject_Type;
