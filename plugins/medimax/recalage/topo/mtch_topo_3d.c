...
if ((dist_type!=2)&&(dist_type!=3)&&(dist_type!=6))
 ...
 normalisation_type=GETV_QCM("Normalisation",(char **)quest);
 nb_classe=-1;
if ((normalisation_type>5)&&(normalisation_type!=10)&&(normalisation_type!=16))
  ...
  /* correction de biais */
	...
	biais= GETV_QCM("Correction de biais ?",(char **)quest);
  ...
  /* partition adaptative ? */
	...
	adaptatif= GETV_QCM("Adaptatif ?",(char **)quest);
  ...
  strcpy(quest[9],"\0");
	...
	reg_type= GETV_QCM("R�ularisation ?",(char **)quest);
  ...
  func_type=1;
	...
	strcpy(quest[0],"L2");
 	...
 	strcpy(quest[2],"\0");
  	...
  	dist_type=GETV_QCM("Critere",(char **)quest);
	...
	strcpy(quest[0],"precis");
 	...
 	strcpy(quest[2],"\0");
  	...
  	PRECISION_SIMULATION=GETV_QCM("Precision",(char **)quest);
...
{
 char *quest[5],nomfichres[500],nomfichier[500],str[500],s[250];
 int min_type,i,reg_type=0,im_invariant;
 ...
 int resolf, e,ans;
	...
	reg_type= GETV_QCM("Regularisation ?",(char **)quest);
	...
	imx_Project_Field_Bspline_topo_3d(nomfichier,nomfichres,min_type,resolf,Jmin,Jmax,reg_type,prec,im_invariant);
...
reg_type,double prec,int im_mask)
{
...
imx_Project_Field_Bspline_topo_3d_p(ch,transfores,transfo_opp, min_type, resolf, Jmin, Jmax, reg_type,prec,mask);
...
int tdebut,tfin,continu,i,nbmax_param;
double *param,*param_norm;
double  mini;
...
toto.width=wdth;toto.height=hght;toto.depth=dpth;
...
_ParamRecalageBspline.chref=ch;
 ...
 /********************RECALAGE ONDELETTE******************************************/
 {
  int l,resol,r,D,i,j,k,ind,flag,topi,topj,topk,compt;
  int ***masque_param;
  int *x0,*x1,*y0,*y1,*z0,*z1;
...
int l,continu,wdth,hght,dpth,max=0,step=0,n,i,j,k;
float dx,dy,dz;
...
int imx_matching_Bspline_topo_momentgeometrique_3d_p(grphic3d *imref, grphic3d *imreca, grphic3d *imres,
                                ...
                                int resolf, double Jmin, double Jmax)
{
 int	wdth,hght,dpth,nb_param, wdth_old=0, hght_old=0, dpth_old=0,i,j,k,ideb,jdeb,kdeb,e;
 double *param,*param_norm, prec;
